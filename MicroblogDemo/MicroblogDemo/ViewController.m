...
- (void)viewDidLoad {
    ...
    self.tableData = @[
                       @{@"username":@"张三",@"icon":@"home_headicon",
                       ...
                       ,@{@"username":@"张三",@"icon":@"home_headicon",
                          ...
                          ,@"pics":@[@"headImg_1",@"headImg_1",@"headImg_1",@"headImg_1",@"headImg_1"],@"map":@"map1"
                          }
                       ,@{@"username":@"张三",@"icon":@"home_headicon",
                          @"content":@" 中国网3月26日讯 据外媒报道，当地时间3月25日，法国总统奥朗德，德国总理默克尔、西班牙首相拉霍伊共同抵达德国之翼航空公司客机的失事地点。报道称，三位国家领导人抵达当地以后，与参加搜救的工作人员在临时指挥中心进行了会面。此外，法、德、西三国领导人在客机坠毁地点附近对在此次空难中的遇难者表示哀悼，并对参与搜救的消防队员表示了感谢。"
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    NSString *reuseIdentifier = [NSString stringWithFormat:@"%@%ld",CellIdentifier,indexPath.row];
     ...
     */
    cell.bodyLabel.attributedText = [NSAttributedString emotionAttributedStringFrom:dict[@"content"] attributes:@{NSFontAttributeName: [UIFont systemFontOfSize:12]}];
    ...
    cell.bodyLabel.linkLongPressHandler = ^(SkyLinkType linkType, NSString *string, NSRange range){
        ...
        SkyActionSheet* aciontSheet= [[SkyActionSheet alloc] initWithTitle:@"Message" cancelButtonTitle:@"Cancel" andOtherButtonTitlesArray:@[@"other",@"Button"]];
        aciontSheet.blurBackground = YES;
        
        //[aciontSheet setButtonBackgroundColor:self.backgroundColor];
        //[aciontSheet setButtonTextColor:self.textColor];
//        
//        if (self.buttonEffectSegmentedControl.selectedSegmentIndex == 0) {
//            
//            aciontSheet.buttonResponse = IBActionSheetButtonResponseFadesOnPress;
//            
//        } else if (self.buttonEffectSegmentedControl.selectedSegmentIndex == 1) {
//            
//            aciontSheet.buttonResponse = IBActionSheetButtonResponseReversesColorsOnPress;
//            
//        } else if (self.buttonEffectSegmentedControl.selectedSegmentIndex == 2) {
//            
//            aciontSheet.buttonResponse = IBActionSheetButtonResponseShrinksOnPress;
//            
//        } else {
//            
//            aciontSheet.buttonResponse = IBActionSheetButtonResponseHighlightsOnPress;
//            [aciontSheet setButtonHighlightTextColor:[UIColor whiteColor]];
//            [aciontSheet setButtonHighlightBackgroundColor:[UIColor redColor]];
//        }
        
        [aciontSheet showInView:self.view];
        NSLog(@"长按");
    };
    ...
    [cell setImageswithURLs:dict[@"pics"]];
